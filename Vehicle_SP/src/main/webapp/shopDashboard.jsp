...
<meta charset="UTF-8">
<title>Proparts Shop Dashboard</title>
</head>
<body class="body" style="background-image: url('img/324554-P9GY6X-129.jpg')"> 
	...
	<h1 class="tt"> Proparts Shop Dashboard </h1>
...
<div class="shop" id="shopSection" style="display: none;">
    <div class="login-container">
        <div class="label"><center>Manage Shop Employees</center></div><br>
        ...
        <a href="#"><div class="button-29">Add Shop Employees</div></a><br><br>
        <a href="#"><div class="button-29">Edit Shop Employees</div></a><br><br>
...
<div class="report" id="reportSection" style="display: none;">
    <div class="login-container">
        <div class="label"><center>Generate shop salles Reports</center></div><br>
       <center> <img src="data:image/png;base64,">
        ...
        <center>
        <a href="#" ><input type="submit" name="submit" value="item report" class="btn btn-primary"/></a><br></center>
